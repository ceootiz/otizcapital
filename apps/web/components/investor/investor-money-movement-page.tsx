...
export function InvestorMoneyMovementPage({ locale, ledger, totals, filters }: { locale: Locale; ledger: InvestorLedgerPage; totals: { profit: number; payout: number; reinvested: number }; filters: { type: string; from: string; to: string } }) {
  const t = COPY[locale];
