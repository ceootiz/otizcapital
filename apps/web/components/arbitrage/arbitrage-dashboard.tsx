...
const STRINGS = {
  ...
  es: {
    greeting: "Panel de referidos",
    logout: "Cerrar sesión",
    linkTitle: "Su enlace de referido",
    linkDesc: "Comparta este enlace. Gana comisión cuando se confirma el depósito de un inversor referido.",
    copy: "Copiar",
    copied: "Copiado",
    statClicks: "Clics",
    statApplications: "Solicitudes",
    statApproved: "Inversores aprobados",
    statDeposits: "Depósitos confirmados",
    statSuspicious: "Clics marcados",
    earningsTitle: "Ganancias",
    accrued: "Devengado",
    paid: "Pagado",
    pending: "Por pagar",
    historyTitle: "Historial de comisiones",
    historyEmpty: "Aún no hay comisiones.",
    colDate: "Fecha",
  ...
  de: {
    greeting: "Empfehlungs-Dashboard",
    logout: "Abmelden",
    linkTitle: "Ihr Empfehlungslink",
    linkDesc: "Teilen Sie diesen Link. Sie erhalten Provision, sobald die Einzahlung eines empfohlenen Investors bestätigt wird.",
    copy: "Kopieren",
    copied: "Kopiert",
    statClicks: "Klicks",
    statApplications: "Bewerbungen",
    statApproved: "Freigegebene Investoren",
    statDeposits: "Bestätigte Einzahlungen",
    statSuspicious: "Markierte Klicks",
    earningsTitle: "Erträge",
    accrued: "Aufgelaufen",
    paid: "Ausgezahlt",
    pending: "Auszuzahlen",
    historyTitle: "Provisionsverlauf",
    historyEmpty: "Noch keine Provisionen.",
    colDate: "Datum",
    colInvestor: "Investor",
    colDeposit: "Einzahlung",
  ...
  zh: {
    ...
    logout: "退出登录",
    linkTitle: "您的推荐链接",
    linkDesc: "分享此链接。当所推荐投资者的存款确认后，您将获得佣金。",
    copy: "复制",
    copied: "已复制",
    statClicks: "点击量",
    statApplications: "申请数",
    statApproved: "已批准投资者",
    statDeposits: "已确认存款",
    statSuspicious: "标记的点击",
    earningsTitle: "收益",
    accrued: "已计提",
    paid: "已支付",
    pending: "待支付",
