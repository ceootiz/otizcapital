...
const STRINGS = {
  ...
  es: {
    ...
    heading: "Calculadora de rendimiento",
    subtitle: "Proyecte sus rendimientos a la tasa de asignación actual de OTIZ CAPITAL.",
    rateBadge: "Tasa anual del {rate}",
    amountLabel: "Importe de inversión",
    durationLabel: "Plazo",
    monthUnit: "mes",
    simpleLabel: "Sin reinversión",
    compoundLabel: "Con reinversión",
    totalSimpleLabel: "Total sin reinversión",
    totalCompoundLabel: "Total con reinversión",
    reinvestGainLabel: "Ganancia por reinversión",
    securityHeading: "Por qué es seguro",
    secRealTitle: "Mercancía real",
    secRealDesc: "El capital está vinculado a dispositivos físicos, no a la especulación.",
    secReportTitle: "Informes operativos",
    secReportDesc: "Informes mensuales con prueba del movimiento de la mercancía.",
    secReviewTitle: "Revisión manual",
    secReviewDesc: "Cada inversor pasa por una revisión manual.",
    secWithdrawTitle: "Retiro controlado",
    secWithdrawDesc: "Retiros solo tras un periodo de retención de 90 días."
  },
  de: {
    back: "Zurück zur Startseite",
    heading: "Rendite-Rechner",
    subtitle: "Berechnen Sie Ihre Rendite zum aktuellen Allokationszins von OTIZ CAPITAL.",
    rateBadge: "{rate} Jahreszins",
    amountLabel: "Anlagebetrag",
    durationLabel: "Laufzeit",
    monthUnit: "Mon.",
    simpleLabel: "Ohne Reinvestition",
    compoundLabel: "Mit Reinvestition",
    totalSimpleLabel: "Gesamt ohne Reinvestition",
    totalCompoundLabel: "Gesamt mit Reinvestition",
    reinvestGainLabel: "Gewinn durch Reinvestition",
    securityHeading: "Warum dies sicher ist",
    secRealTitle: "Reale Waren",
    secRealDesc: "Das Kapital ist an physische Geräte gebunden, nicht an Spekulation.",
    secReportTitle: "Operative Berichterstattung",
    secReportDesc: "Monatliche Berichte mit Nachweis der Warenbewegung.",
    secReviewTitle: "Manuelle Prüfung",
    secReviewDesc: "Jeder Investor durchläuft eine manuelle Prüfung.",
    secWithdrawTitle: "Kontrollierte Auszahlung",
    secWithdrawDesc: "Auszahlungen erst nach einer Haltefrist von 90 Tagen."
  },
  zh: {
    back: "返回首页",
    heading: "收益计算器",
    subtitle: "按 OTIZ CAPITAL 当前配置利率测算您的收益。",
    rateBadge: "年化利率 {rate}",
    amountLabel: "投资金额",
    durationLabel: "期限",
    monthUnit: "个月",
    simpleLabel: "不复投",
    compoundLabel: "复投",
    totalSimpleLabel: "不复投总额",
    totalCompoundLabel: "复投总额",
    reinvestGainLabel: "复投收益",
    securityHeading: "为何安全",
    secRealTitle: "真实商品",
    secRealDesc: "资本与实体设备挂钩，而非投机。",
    secReportTitle: "运营报告",
    secReportDesc: "每月报告并附商品流转凭证。",
    secReviewTitle: "人工审核",
    secReviewDesc: "每位投资者均须经过人工审核。",
    secWithdrawTitle: "受控提现",
    secWithdrawDesc: "仅在 90 天持有期后方可提现。"
  }
} as const;
