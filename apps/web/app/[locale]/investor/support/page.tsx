...
const COPY = {
  ...
  ru: { eyebrow: "Помощь", title: "Мои обращения", description: "Отправьте вопрос команде OTIZ и следите за его статусом здесь.", formTitle: "Новое обращение", formDesc: "Описывайте один вопрос в одном обращении. По возможности укажите сделку, отчёт или платёж.", category: "Тема", categories: ["Деньги", "Документы", "Отчёты", "Аккаунт", "Другое"], subject: "Кратко опишите вопрос", message: "Что произошло и какая помощь нужна?", submit: "Отправить обращение", sent: "Обращение отправлено. Команда может начать его проверку.", error: "Заполните тему, заголовок и описание обращения.", history: "История обращений", empty: "У вас пока нет обращений в поддержку.", telegram: "Открыть Telegram", reply: "Ответ команды", status: { OPEN: "Получено", ACKNOWLEDGED: "На рассмотрении", RESOLVED: "Решено" } },
  es: { eyebrow: "Ayuda", title: "Mis solicitudes", description: "Envíe una consulta al equipo de OTIZ y siga su estado aquí.", formTitle: "Nueva solicitud", formDesc: "Describa un asunto por solicitud. Indique la operación, el informe o el pago relacionado cuando sea posible.", category: "Tema", categories: ["Dinero", "Documentos", "Informes", "Cuenta", "Otro"], subject: "Asunto breve", message: "¿Qué ocurrió y qué ayuda necesita?", submit: "Enviar solicitud", sent: "Su solicitud fue enviada. El equipo ya puede revisarla.", error: "Complete el tema, el asunto y el mensaje.", history: "Historial de solicitudes", empty: "Aún no ha enviado solicitudes de soporte.", telegram: "Abrir Telegram", reply: "Respuesta del equipo", status: { OPEN: "Recibida", ACKNOWLEDGED: "En revisión", RESOLVED: "Resuelta" } },
